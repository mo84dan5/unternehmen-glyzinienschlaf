...
async function main() {
  ...
  movingBallRed(...[-20, 0, 0], ...[125, 250, -135], scene, camera)
  // ---- ここまで↑ ---- //
  // ---- にょろにょろコインの制作 ---- //
  ...
  const quiz = [
    ...
    [90, 310, -210, 22, 'quiz-4th-floor-02', 'きくび'],
    [90, 310, -170, 23, 'quiz-4th-floor-03', '2'],
    [50, 310, -130, 24, 'quiz-4th-floor-04', 'ダブリング'],
    [70, 310, -270, 25, 'quiz-4th-floor-05', 'アイビスペイントX'],
    [130, 310, -290, 26, 'quiz-4th-floor-06', '魔術師魔術修行中'],
    [170, 310, -210, 27, 'quiz-4th-floor-07', 'アレクベア'],
