...
async function main() {
  ...
  const quiz = [
    ...
    [80, 10, -190, 2, 'quiz-1st-floor-02', '友達'],
    [80, 10, -270, 3, 'quiz-1st-floor-03', 'ケセランパサラン'],
    [120, 10, -270, 4, 'quiz-1st-floor-04', '徳'],
    [100, 10, -290, 5, 'quiz-1st-floor-05', 'コレ'],
    ...
    [70, 110, -270, 13, 'quiz-2nd-floor-06', 'おはようございます'],

    [80, 210, -190, 14, 'quiz-3rd-floor-01', '下僕'],
    [120, 210, -270, 15, 'quiz-3rd-floor-02', 'エレメントマーク'],
    [100, 210, -290, 16, 'quiz-3rd-floor-03', 'バタフライピー'],
    [80, 210, -270, 17, 'quiz-3rd-floor-04', 'クリぼっち'],
    [150, 210, -130, 18, 'quiz-3rd-floor-05', '25521571'],
    [190, 210, -230, 20, 'quiz-3rd-floor-06', '戦場の女神'],
    [100, 210, -110, 21, 'quiz-3rd-floor-07', '雪'],

    [70, 310, -230, 21, 'quiz-3rd-floor-01', 'LEALILA'],
    [90, 310, -210, 22, 'quiz-3rd-floor-02', 'きくび'],
    [90, 310, -170, 23, 'quiz-3rd-floor-03', '2'],
    [50, 310, -130, 24, 'quiz-3rd-floor-04', 'ダブリング'],
    [70, 310, -270, 25, 'quiz-3rd-floor-05', 'アイビスペイントX'],
    [130, 310, -290, 26, 'quiz-3rd-floor-06', '魔術師魔術修行中'],
    [170, 310, -210, 27, 'quiz-3rd-floor-07', 'アレクベア'],
    [170, 310, -170, 27, 'quiz-3rd-floor-08', '1271'],
    [150, 310, -130, 27, 'quiz-3rd-floor-09', '33'],
  ]
